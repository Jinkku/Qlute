...
public partial class EndScreen : ColorRect
{
	...
	private void FC()
	{
		ComboScreen.Texture = GD.Load<Texture2D>("res://SelectableSkins/Slia/Game/EndScreen/FC.png");
	...
	{
		Modulate = new Color(0f, 0f, 0f, 0f);
		ComboScreen.Texture = GD.Load<Texture2D>("res://SelectableSkins/Slia/Game/EndScreen/Bad.png");
		Tween.TweenProperty(this, "modulate", new Color(1f, 1f, 1f, 1f),1f).SetTrans(Tween.TransitionType.Cubic).SetEase(Tween.EaseType.Out);
	...
	{
		Modulate = new Color(0f, 0f, 0f, 0f);
		ComboScreen.Texture = GD.Load<Texture2D>("res://SelectableSkins/Slia/Game/EndScreen/Good.png");
		Tween.TweenProperty(this, "modulate", new Color(1f, 1f, 1f, 1f), 1f).SetTrans(Tween.TransitionType.Cubic).SetEase(Tween.EaseType.Out);
		Tween.TweenInterval(3);
	}
	private void MAX()
	{
		Modulate = new Color(0f, 0f, 0f, 0f);
		ComboScreen.Texture = GD.Load<Texture2D>("res://SelectableSkins/Slia/Game/EndScreen/MAX.png");
		Tween.TweenProperty(this, "modulate", new Color(1f, 1f, 1f, 1f), 1f).SetTrans(Tween.TransitionType.Cubic).SetEase(Tween.EaseType.Out);
		Tween.TweenInterval(3);
	}
}
